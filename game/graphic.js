function init()
{
    ...
    ennemy = new Player("ennemy", 0x000000, new THREE.Vector2(50, 0), 0);
...
function Ground(color, size_x, size_y, nb_tile)
{
    ...
    tmpGround.position.x = maxX - (sizeOfTileX * nb_tile / 2) + sizeOfTileX;
    tmpGround.position.y = maxY - (sizeOfTileY * nb_tile / 2);
    scene.add(tmpGround);
...
{
    pointLight = new THREE.PointLight(color, 3350, 3350);
